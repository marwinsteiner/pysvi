...
- **Rate views, not just flat rates**: every rate input accepts a flat float, a fitted [interest-rate-models](https://pypi.org/project/interest-rate-models/) curve or model, or any callable $T \mapsto r(T)$ (e.g. a cubic spline)
